            ...
            <div class="loginFrom">
                    ...
                    <el-form :model="loginUser" :rules="rules" ref="loginForm" label-width="80px" class="loginForm">
                        ...
                        <el-form-item label="密码" prop="password">
                            <el-input type="password" v-model="loginUser.password" aria-placeholder="请输入密码"></el-input>
                        </el-form-item>
                        <el-form-item>
...
.login{
    ...
    width: 100%;
    height: 100%;
    background: url(../assets/coffee-cultivation-kv.jpg) no-repeat center center;
